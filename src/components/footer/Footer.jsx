...
function Footer() {
  ...
  return (
    <>
      <footer className={darkMode ? "sectionDark" : "sectionLight"}>
        <div className="sectionWrapper footerWrapper">
          <div className="sectionContent footerContent">
            ...
            <nav className="footerTopWrapper" aria-label="Footer main links">
              <motion.ul
            ...
            <nav
              className="footerSocialsWrapper"
            ...
            >
              ...
              >
                <motion.li variants={fadeInWithEase2}>
                  <a
                    href="https://www.instagram.com/rangkaempatstudio"
                ...
                <motion.li variants={fadeInWithEase2}>
                  <a
                    href="https://www.facebook.com/rangkaempatstudio"
                    className="footerLink"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <motion.li variants={fadeInWithEase2}>
                  <a
                    href="https://www.tiktok.com/@rangkaempat"
                    className="footerLink"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <motion.li variants={fadeInWithEase2}>
                  <a
                    href="https://www.linkedin.com/company/rangka-empat-studio"
                    className="footerLink"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="footerBottomContainer">
              ...
              <small className="textLight">
                © 2025 RANGKA EMPAT STUDIO
                <br />
                ALL RIGHTS RESERVED
              </small>
            </div>
